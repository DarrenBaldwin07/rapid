...
// Currently, the rapid file-based router only officially supports `query` and `mutation` handler types.
// The specific HTTP method handlers (GET, POST, DELETE, PUT, PATCH) are deprecated and will be removed in a future version.
enum RouteHandler {
	// Officially supported handler types
	Query(Handler),
	Mutation(Handler),
...
/// Currently, only `query` and `mutation` handler types are officially supported. The specific HTTP method handlers 
/// (GET, POST, DELETE, PUT, PATCH) are deprecated and will be removed in a future version.
/// This macro also supports middleware via a "_middleware.rs" file
///
...
fn generate_handler_tokens(route_handler: Handler, parsed_path: &str, handler_type: &str) -> proc_macro2::TokenStream {
	...
	match handler_type {
		...
		// DEPRECATED: Support for specific HTTP type handlers (ex: `get` or `post` etc)
		// These are now deprecated and will be removed in a future version.
		// Users should transition to using only `query` and `mutation` handlers.
		_ => {
			eprintln!("Warning: The '{}' handler type is deprecated. Please use 'query' or 'mutation' instead.", handler_type);
...
fn parse_handlers(route_handlers: &mut Vec<RouteHandler>, file_contents: String, handler: Handler) {
	...
	// Deprecated handler types - will be removed in a future version
		...
		eprintln!("Warning: The 'get' handler type is deprecated. Please use 'query' instead.");
		...
		eprintln!("Warning: The 'post' handler type is deprecated. Please use 'mutation' instead.");
		...
		eprintln!("Warning: The 'delete' handler type is deprecated. Please use 'mutation' instead.");
		...
		eprintln!("Warning: The 'put' handler type is deprecated. Please use 'mutation' instead.");
		...
		eprintln!("Warning: The 'patch' handler type is deprecated. Please use 'mutation' instead.");
