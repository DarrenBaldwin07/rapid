...
use tiny_gradient::{GradientStr, RGB, GradientDisplay};
...
pub fn rapid_log_target() -> GradientDisplay<'static, [RGB; 4]> {
    let target = GradientStr::gradient(&"[rapid-web::logger]", [RGB::new(9, 42, 208), RGB::new(26, 78, 96), RGB::new(9, 42, 208), RGB::new(14, 197, 255)]);
    target
}
