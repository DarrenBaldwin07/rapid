...
`} />
<div className='mt-2'></div>
> For more rapid examples head over to the "/examples" directory in our <a href='https://github.com/Cincinnati-Ventures/rapid/tree/main/examples' target='_blank'>Github</a>
